...
//Using chronos literals namespace
...
//Functional command for recording samples
...
//Main Function to initiate USRP recording
int UHD_SAFE_MAIN(int argc, char* argv[])
{
    ...
    //Set up each channel with multithreading and the proper parameters for streaming
    ...
    std::cout << "Files written to " << file << ".\n";
    std::cout << "File is " << rate*total_time*4/(1e6) << "MB.\n";
    return EXIT_SUCCESS;
}